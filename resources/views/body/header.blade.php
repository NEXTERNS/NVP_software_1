<nav class="navbar">
    ...
    <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <img  class="wd-30 rounded-circle" src="{{(!empty($profileData -> photo))? 
                  ...
                  <img  class="wd-70 rounded-circle" src="{{(!empty($profileData -> photo))? 
                                        url('upload/admin_image/').'/'.$profileData->photo : url('upload/no_image.jpg') }}">									</div>
                ...
                <ul class="list-unstyled p-1">
                  <li class="dropdown-item py-2">
                    <a href="{{route('profile.update')}}" class="text-body ms-0">
                      <i class="me-2 icon-md" data-feather="user"></i>
                      <span>Profile</span>
                    </a>
                  </li>
                  <li class="dropdown-item py-2">
                    <a href="{{route('profile.partials.update-password-form')}}" class="text-body ms-0">
                  ...
                  <li class="dropdown-item py-2">
                    <a href="javascript:;" class="text-body ms-0">
                      <i class="me-2 icon-md" data-feather="log-out"></i>
                        <input type="submit" value="Log out " class="bg-dark text-white ">
                    </form>
                    </a>
                  </li>
