    ...
    <form action="{{ route('expenditure.update', $expenditure->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="number" name="amount" value="{{ $expenditure->amount }}" class="form-control" >
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <select class="js-example-basic-single form-select" data-width="100%">
                <option value="{{ $expenditure->category }}"  selected>{{ $expenditure->category }}</option>
        ...
        <div class="input-group flatpickr" id="flatpickr-date">
          <input type="text" name="date" value="{{ $expenditure->date }}" class="form-control" placeholder="Select date" data-input>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" style="height:150px"  name="detail" placeholder="Detail"> {{ $expenditure->detail }}</textarea>
                    </div>
                </div>
