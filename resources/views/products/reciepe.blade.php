...
<div class="page-content">
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Reciepe page</a></li>
  ...
  <div class="card-body">
    <div class="container-fluid d-flex justify-content-between">
      <div class="col-lg-3 ps-0">
        <a href="#" class="noble-ui-logo logo-light d-block mt-3">TK<span>ELECTRONICS</span></a>                 
        <p class="mt-1 mb-1"><b>Best Electronics Store in Bamenda</b></p>
        <p>108,<br> commecial Avenue St,<br>Bamenda, WC1B 3NA.</p>
        <h5 class="mt-5 mb-2 text-muted">Sold to :</h5>
        <p>Joseph E Carr,<br> 102, 102  gana Street,<br> Bamenda, W3 3PR.</p>
      </div>
      <div class="col-lg-3 pe-0">
        <h4 class="fw-bolder text-uppercase text-end mt-4 mb-2">P.O box</h4>
        <h6 class="text-end mb-5 pb-4"># INV-002308</h6>
        <p class="text-end mb-1">Balance Due</p>
        <h4 class="text-end fw-normal">$ 72,420.00</h4>
        <h6 class="mb-0 mt-3 text-end fw-normal mb-2"><span class="text-muted">Purchase Date :</span> 25rd Jan 2022</h6>
    ...
    <div class="container-fluid w-100">
      <a href="javascript:;" class="btn btn-primary float-end mt-4 ms-2"><i data-feather="send" class="me-3 icon-md"></i>Download Reciept</a>
